...
DacHelper::DacHelper(dac::Generator &gen, SymbolFactory &fac, SymbolTable &st, bool verb)
    : gen(gen), factory(fac), symbolTable(st), verbose(verb) {}
...
//           SymbolTable &st = SymbolTable::GetInstance(),bool berbose_):DacHelper(gen,fac,st),verbose(verbose_){}
